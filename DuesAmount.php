                ...
                <div class="container-fluid">
                    <div class="sec-title">
                        ...
                        <div class="container">
                            <div class="col-lg-12">
                                <br><br>
                                <h1 class="text-warning text-center"> All Dues Amounts on every customer </h1>
                                <br>
                                <table id="tabledata" class=" table table-striped table-hover table-bordered">
                                    ...
                                    <?php
                                    include 'dbcon.php';
                                    $q = "SELECT customerdb.name, custdueamt.dueAmt FROM `custdueamt`, customerdb where custdueamt.custid=customerdb.id;";
