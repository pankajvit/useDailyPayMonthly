...
<head>
    ...
    <!-- Custom CSS -->
    <link href="css/dailyTask.css" rel="stylesheet">
    <!-- Favicon -->
                ...
                <div class="container-fluid">
                    <div class="sec-title">
                        ...
                        <div class="container">
                            <div class="col-lg-12">
                                <br><br>
                                <h1 class="text-warning text-center"> Display Collection Amounts </h1>
                                <br>
                                <table id="tabledata" class=" table table-striped table-hover table-bordered">
                                    ...
                                    <?php
                                    include 'dbcon.php';
                                    $q = "SELECT dailytaskdb.date, customerdb.name, dailytaskdb.paidAmt FROM `dailytaskdb`, customerdb where dailytaskdb.customerid=customerdb.id;";
