...
<head>
    ...
    <!-- Custom CSS -->
    <link href="css/customerGroup.css" rel="stylesheet">
    <!-- Favicon -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <option value="volvo">Customer-1</option>
                                                <option value="fiat">Customer-2</option>
                                                <option value="audi">Customer-3</option>
                                                <option value="audi">Customer-4</option>
                                            </select> -->
                                            </div>
